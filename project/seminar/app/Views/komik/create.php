...
<div class="container" style="font-family: cursive;">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3" style="color: #F08080"><b>Form Tambah Data Komik</b></h2>
            ...
            <form action="/komik/save" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn text-light" style="background-color: #CD5C5C;">Tambah Data</button>
            </form>
        </div>
    </div>
</div>
